...
async def amireallyalive(event):
    ...
    VFF35_ALIVE_TEXT = "❬ تـليثون العـرب - Telethon-Arabe ، 🕸  ❭ :"
...
———————×———————
الأمر ⦙ ( .استخدامي )
الشرح :   يضهر لك كمية استخدامك لكوبرا
———————×———————
الأمر ⦙ ( .تاريخ التنصيب )
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None :
    ...
    async def inlineVFF35(VFF35):
        ...
        query = VFF35.text
        await bot.get_me()
        if query.startswith("اوامر القروب(?: |$)(.*)") and VFF35.query.user_id == bot.uid:
