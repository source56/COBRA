...
def register(**args):
    ...
    def decorator(func):
        if not disable_edited:
            iqqhtani.add_event_handler(func, MessageEdited(**args))
        iqqhtani.add_event_handler(func, NewMessage(**args))
        try:
